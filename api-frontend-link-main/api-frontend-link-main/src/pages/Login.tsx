...
const Login: React.FC = () => {
  ...
  return (
    <div className="container mx-auto px-4 py-8 min-h-screen flex items-center justify-center bg-gradient-to-br from-purple-50 to-indigo-50">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-4 pt-2">
                ...
                <Button
                  ...
                  className="w-full flex items-center justify-center gap-2 border-2 border-gray-300 hover:border-purple-500 hover:bg-purple-50 transition-all duration-200"
                >
